...
export const addHospital = async (req: Request, res: Response) => {
  ...
  //       avatarImage: [
  //         "/images/hospitals/petcarehub-1.jpg",
  //         "/images/hospitals/petcarehub-2.jpg",
  //         "/images/hospitals/petcarehub-3.jpg",
  //         "/images/hospitals/petcarehub-4.jpg",
  //       ],
  //       email: "care@petcarehub.mn",
  //       backgroundImage: "/images/hospitals/petcarehub-bg.jpg",
  //       rating: 4,
