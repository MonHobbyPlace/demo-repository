...
export default function OnboardingThree() {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-between text-center bg-[#e1f7f5] text-[#03346E] px-6 py-10">
      ...
      <div className="flex gap-4 w-full max-w-md">
        ...
        <button
          onClick={() => router.push("/login")}
          className="border border-[#03346E] text-[#03346E] font-semibold rounded-full w-full py-3"
        >
          Login
        </button>
      </div>
